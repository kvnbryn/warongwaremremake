...
class AdminSeatController extends Controller
{
    ...
    public function showTmptDudukAdmin()
    {
        if (!Session::get('adminLogin')) {
    ...
    public function searchSeatAdmin(Request $request)
    {
    ...
    public function storeSeat(Request $request)
    {
        ...
        return redirect()->route('showTmptDudukAdmin')->with('pesan',"Penambahan data berhasil");
    }
    ...
    public function editSeat(Request $request)
    {
        ...
        $data_update->save();
        return redirect()->route('showTmptDudukAdmin')->with('pesan',"Update data Seat {$kode_validate} berhasil");
    }
    ...
    public function deleteSeat($id)
    {
        ...
        $kode_seat = $data->nama;
        Seat::destroy($id);
        return redirect()->route('showTmptDudukAdmin')->with('pesan',"Menghapus Seat {$kode_seat} berhasil");
    }
    /* ===== CRUD SEAT END ====== */
