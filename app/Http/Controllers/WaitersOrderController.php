...
class WaitersOrderController extends Controller
{
    public function __construct()
    {
        if (!Session::get('waitersLogin')) {
            return redirect()->route('waitersSignIn')->with('alert', 'Anda Harus Login Terlebih Dahulu!');
        }
    }

    // menampilkan tabel daftar orderan
    public function showOrderWaiters()
    {
        if (!Session::get('waitersLogin')) {
            return redirect()->route('waitersSignIn')->with('alert', 'Anda Harus Login!');
        }
        else {
            ...
            return view('waiters.tabelOrder', ['data_orders' => $data_orders]);
        }
    }
    ...
    public function searchOrder(Request $request)
    {
        ...
        return view('waiters.tabelOrder', ['data_orders' => $res]);
    }
    ...
    public function detailOrder($id)
    {
        ...
        // print_r($res);
        return view('waiters.detailOrderModal', ['detail_orders' => $detailOrders]);
    }
}
