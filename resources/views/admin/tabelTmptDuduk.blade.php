...
@section('content')
    ...
    <div class="modal fade" id="formEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('editSeatAdmin') }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="container-md p-4 my-3 border">
                        <div class="row">
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    <form action="{{ route('searchSeat') }}" method="get">
                        ...
                        <a href="{{ route('showTmptDudukAdmin') }}"><input class="btn btn-danger btn-sm" type="button" name='reset' value="Reset"></a>    
                    </form>
                </div>
                <div class="col-sm-6">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-row">
                                    <form class="" action="{{ route('updateStatusSeatAdmin', ['seatId' => $seat->id]) }}" method="post">
                                        @method('PUT')
                                        @csrf
                                    ...
                                    <form class="" action="{{ route('deleteSeatAdmin', ['seatId' => $seat->id]) }}" method="post">
                                        @method('delete')
                                        @csrf
