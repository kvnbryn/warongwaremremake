    ...
    <div class="modal fade" id="formInsertMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('addMenuAdmin', ['kategori' => 'minuman']) }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <!-- Modal Edit Start-->
     <div class="modal fade" id="formEditMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('editMenuAdmin', ['kategori' => 'minuman']) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="container-md p-4 my-3 border">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    <!-- buat form search  -->
                    <form action="{{ route('searchMenu', ['kategori' => 'minuman']) }}" method="get">
                        @csrf
                        ...
                        <a href="{{ route('showMinuman') }}"><input class="btn btn-danger btn-sm" type="button" name='reset' value="Reset"></a>    
                    </form>
                </div>
                <div class="col-sm-6">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-row">
                                    ...
                                    <form class="" action="{{ route('deleteMenuAdmin', ['menuId' => $drink->id]) }}" method="post">
                                        @method('delete')
                                        @csrf
