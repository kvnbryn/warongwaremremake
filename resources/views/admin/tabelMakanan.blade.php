...
@section('content')
    ...
    <div class="modal fade" id="formInsertMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('addMenuAdmin', ['kategori' => 'makanan']) }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="formEditMenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('editMenuAdmin', ['kategori' => 'makanan']) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="container-md p-4 my-3 border">
                ...
                <table class="table table-striped">
                    ...
                    @forelse ($foods as $food)
                        <tr>
                            ...
                            <td>{{$food->harga}}</td>
                            <td>{{$food->stok}}</td>
                            <td><img src="{{ url('storage/img/'.$food->foto) }}" width="50px" height="50px"></td>
                            <td>
                                <div class="d-flex flex-row">
                                    ...
                                    <form class="" action="{{ route('deleteMenuAdmin', ['menuId' => $food->id]) }}" method="post">
                                        @method('delete')
                                        @csrf
